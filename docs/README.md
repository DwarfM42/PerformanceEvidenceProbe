...
| [License and provenance audit](LICENSE-AUDIT-2026-09-04.md) | Historical v0.1.0 record | License decision, source provenance, dependency notices, and future-reuse boundary. |
